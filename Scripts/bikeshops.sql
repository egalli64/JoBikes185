...
CREATE TABLE USER_DATA (
    USER_DATA_ID NUMBER(5) UNIQUE NOT NULL,
    USER_DATA_FIRSTNAME VARCHAR2(20),
    USER_DATA_LASTNAME VARCHAR2(20),
    USER_DATA_GENDER VARCHAR2(1),
    USER_DATA_CREDITCARD VARCHAR2(16)
);

 ALTER TABLE USER_DATA
 ADD CONSTRAINT FK_USER_DATA_ID FOREIGN KEY (USER_DATA_ID)
 REFERENCES USERS(USER_ID);

INSERT INTO USER_DATA VALUES(1,'King','Lion', 'M', '0000000000000001');
